# Theme 2 — What Does It Mean to Be a University Student? — Manuscript
...
Help students understand that becoming a university student is not about learning new campus systems — it's about taking on real independence and responsibility for the first time, often before anyone tells them that's what's happening.

## Essential Question

Is being a university student something that simply happens to you — or something you have to actively become?

---

## Foundation Vocabulary (8 words)

independent, responsibility, attendance, submission, assignment, manage, challenge, develop

`challenge` and `develop` are deliberate spiral review words from Theme 1 (Knowing Myself).

## Advanced Vocabulary (7 new words + 1 reinforced)

independence, self-discipline, initiative, commitment, adapt, priority, deadline — plus **responsibility**, reused (not duplicated) from Foundation and deliberately deepened in a new context, the same way Theme 1 treated "personality."

---

## Foundation Reading Passage (220 words)
...
## Advanced Reading Passage (534 words)
...
Foundation stays concrete and personal — daily choices (attendance, one missed class, remembering a deadline). Advanced takes a genuinely different angle: the psychological shift from externally-imposed structure (teachers, timetables) to self-generated structure (self-discipline, initiative, commitment) — the same way Theme 1 Advanced took a different angle (nature vs. nurture) rather than restating Foundation's message in harder vocabulary.

## Revision history

1. First draft (Educational Goal, Essential Question, both passages).
2. Foundation's ending revised to close on opportunity/growth rather than "nobody is watching"; Advanced's opening trimmed ~16%; new closing line added to Advanced.
3. "obedient" removed from Advanced paragraph 2 — same idea (success under high school came from following externally-provided structure), softer tone toward high school education.
