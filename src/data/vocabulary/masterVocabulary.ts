...
export const MASTER_VOCABULARY: VocabEntry[] = [
  ...
  // of the Wet Can") and its 6-word list (science, observation,
  // hypothesis, phenomenon, experiment, curiosity) with the approved
  // "Science Is Part of Our Lives" passage's frozen 10-word list. None of
  // the old 6 words occur in the new passage. All 6 old ids are
  // repurposed below; 4 new ids are added.

  {
    ...
    coreMeaning: 'To watch or study something carefully in order to learn about it.',
    examples: [
      'People observe the world, ask questions, and try to find out how things work.',
      'Scientists observe the world around them carefully before they try to explain it.',
    ],
    relatedWords: ['investigation', 'discover', 'material'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s starting point for what science actually is — not expertise, but the simple act of watching the world carefully.',
    collocations: ['observe the world', 'carefully observe', 'observe and ask questions', 'observations of', 'observe how something works'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A person who has a lot of knowledge or skill in a particular subject.',
    examples: [
      'Science is sometimes seen as something that happens in laboratories or is studied by experts.',
      'The passage argues that science is not only for experts — ordinary people already benefit from it every day.',
    ],
    relatedWords: ['ordinary', 'investigation', 'discover'],
    tags: ['science', 'core'],
    themeNote: 'Named in the passage\'s opening sentence specifically to set up the idea the passage then complicates — science as something only experts do.',
    collocations: ['studied by experts', 'a group of experts', 'expert knowledge', 'not only for experts', 'become an expert'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A statement about what is likely to happen in the future, especially the weather, based on available information.',
    examples: [
      'Weather forecasts are based on observations of the atmosphere and large amounts of data.',
      'A forecast is never a guarantee, but it is based on real evidence, not guessing.',
    ],
    relatedWords: ['atmosphere', 'observe', 'investigation'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s first concrete, everyday example of hidden science — most people check a forecast without thinking about the observation and data behind it.',
    collocations: ['a weather forecast', 'based on', 'forecast the weather', 'an accurate forecast', 'check the forecast'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'The layer of gases that surrounds the Earth.',
    examples: [
      'Weather forecasts are based on observations of the atmosphere and large amounts of data.',
      'Scientists study the atmosphere to understand and predict weather patterns.',
    ],
    relatedWords: ['forecast', 'observe', 'material'],
    tags: ['science', 'core'],
    themeNote: 'This word also appears in Theme 7 (caring-for-our-planet, id `cp-f-07`), where it names the same physical layer of gases in an environmental/climate context. Here it names the same layer in a meteorological/forecasting context — a genuinely close overlap, flagged honestly rather than treated as a coincidence.',
    collocations: ['observations of the atmosphere', "Earth's atmosphere", 'in the atmosphere', 'study the atmosphere', 'the atmosphere and weather'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'An illness that affects a person, animal, or plant, often with a specific cause.',
    examples: [
      'Medicine uses scientific knowledge about the human body and diseases.',
      'Understanding how a disease spreads is one of the most useful things science can teach us.',
    ],
    relatedWords: ['affect', 'material', 'investigation'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s second everyday example (medicine) — grounding "science" in something as immediate and personal as staying healthy.',
    collocations: ['a disease', 'knowledge about disease', 'cause a disease', 'prevent disease', 'fight disease'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'To have an influence on something, often causing a change.',
    examples: [
      'The food we eat can be kept safe for longer because people have studied how temperature and bacteria affect it.',
      'Small changes in temperature can affect how quickly food goes bad.',
    ],
    relatedWords: ['investigation', 'material', 'disease'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s causal verb for its food-safety example — naming exactly what scientists had to study (how temperature and bacteria affect food) before that knowledge could become useful.',
    collocations: ['affect it', 'affect how something works', 'directly affect', 'can affect', 'affect the result'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A substance that things are made of, or that is studied or used for a particular purpose.',
    examples: [
      'Scientists study materials, energy, plants, animals, the human body, and many other things.',
      'New materials, discovered through scientific research, are often used to build everyday objects.',
    ],
    relatedWords: ['discover', 'investigation', 'affect'],
    tags: ['science', 'core'],
    themeNote: 'One of several broad subjects the passage names to show how wide scientific study actually is — not limited to one narrow field.',
    collocations: ['study materials', 'new materials', 'materials and energy', 'materials science', 'made of materials'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'To find or learn something that was not known before.',
    examples: [
      'What they discover can later be used by engineers, doctors, farmers, companies, and ordinary people.',
      'Scientists continue to discover new things about materials, energy, and the human body.',
    ],
    relatedWords: ['material', 'investigation', 'ordinary'],
    tags: ['science', 'core'],
    themeNote: 'Third appearance of this word family across the platform (Theme 3: discovering yourself, personal and internal; Theme 9: "discovery" as a historical/scientific noun; here: the verb, in its most literal scientific sense — scientists discovering new facts about the world). Worth naming honestly rather than treating as new.',
    collocations: ['what they discover', 'discover new things', 'scientists discover', 'discover something about', 'later discover'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Not special or unusual; normal, everyday.',
    examples: [
      'What they discover can later be used by engineers, doctors, farmers, companies, and ordinary people.',
      'Science is not separate from everyday life — it is already part of ordinary things people do.',
    ],
    relatedWords: ['expert', 'discover', 'investigation'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s deliberate counterpart to "expert" — its whole argument depends on showing that scientific knowledge reaches ordinary people, not only specialists.',
    collocations: ['ordinary people', 'ordinary things', 'an ordinary day', 'ordinary life', 'not ordinary'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'The careful and systematic study of something in order to find out more about it.',
    examples: [
      'It is one way people try to understand the world through observation and investigation.',
      'Every scientific discovery begins with careful investigation.',
    ],
    relatedWords: ['observe', 'discover', 'material'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s final, summarizing word for what science actually does — paired directly with "observation" in its concluding sentence.',
    collocations: ['through investigation', 'careful investigation', 'a scientific investigation', 'investigation and observation', 'further investigation'],
  },

  // ── Science in Everyday Life — Advanced ──────────────────────────────────────
  // New — Theme 10 previously had no Advanced level. Built against the
  // approved "What Makes an Approach Scientific?" passage's frozen
  // 10-word list.

  {
    id: 'se-s-01',
    word: 'systematic',
    japanese: '体系的な・一定の方法に従った',
    pos: 'adjective',
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Done according to a fixed plan or method, in an organized and careful way, not randomly.',
    examples: [
      'It is also a systematic way of testing whether an explanation is supported by evidence.',
      'A systematic approach means following the same careful steps every time, not just checking randomly.',
    ],
    relatedWords: ['evidence', 'hypothesis', 'consistent'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s opening claim about what science actually is — not just knowledge, but a systematic method for testing explanations.',
    collocations: ['a systematic way', 'systematic testing', 'a systematic approach', 'systematic investigation', 'systematically test'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Facts, data, or observations that show whether an explanation is likely to be true.',
    examples: [
      'It is also a systematic way of testing whether an explanation is supported by evidence.',
      'We may notice evidence that supports an idea and ignore evidence that does not.',
    ],
    relatedWords: ['systematic', 'reliable', 'bias'],
    tags: ['science', 'core'],
    themeNote: 'Reinforcement of Theme 5 (facts-or-fake), where evidence meant support for a claim in an information/media context; here it is scientific evidence collected through systematic investigation — a related but more technical sense.',
    collocations: ['supported by evidence', 'notice evidence', 'evidence that supports', 'strong evidence', 'better evidence'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A possible explanation, proposed before testing, that can be examined through investigation.',
    examples: [
      'Researchers may then form a hypothesis and design an experiment to test it.',
      'A hypothesis is not a final answer — it is a starting point that a scientific investigation can test.',
    ],
    relatedWords: ['systematic', 'evidence', 'variable'],
    tags: ['science', 'core'],
    themeNote: 'Names the exact starting move of scientific investigation — before data, before an experiment, researchers first propose something testable. Previously this theme\'s own Foundation word (retired `se-f-03`); now rebuilt as an Advanced word matching its more precise role in the new passage.',
    collocations: ['form a hypothesis', 'test a hypothesis', 'design an experiment to test', 'a hypothesis about', 'propose a hypothesis'],
  },

  {
    id: 'se-s-04',
    word: 'variable',
    japanese: '変数・結果に影響しうる要因',
    pos: 'noun',
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Something that can change or be different, and that might affect the result of an investigation.',
    examples: [
      'They collect data, compare results, and consider whether other variables could have affected what they observed.',
      'A scientific experiment therefore tries to control other variables and make a fair comparison.',
    ],
    relatedWords: ['hypothesis', 'correlation', 'consistent'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s key tool for ruling out alternative explanations — in the drink/exam example, sleep and study time are both variables that could explain the result instead of the drink.',
    collocations: ['other variables', 'control variables', 'variables could have affected', 'consider variables', 'a variable in the experiment'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A connection or pattern between two things that happen together, without one necessarily causing the other.',
    examples: [
      'The drink and the higher scores may show a correlation, but correlation alone does not prove causation.',
      'A correlation between two things is not, by itself, proof of a cause-and-effect relationship.',
    ],
    relatedWords: ['causation', 'coincidence', 'evidence'],
    tags: ['science', 'core'],
    themeNote: 'Paired directly with "causation" in the passage\'s central distinction — the single most important conceptual pair in the reading.',
    collocations: ['show a correlation', 'a correlation between', 'correlation alone', 'a strong correlation', 'correlation does not prove'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A relationship in which one thing directly causes another to happen.',
    examples: [
      'The drink and the higher scores may show a correlation, but correlation alone does not prove causation.',
      'Proving causation usually requires more than noticing that two things happened at the same time.',
    ],
    relatedWords: ['correlation', 'variable', 'coincidence'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s central conceptual distinction depends on this word — correlation is what you observe; causation is the stronger claim that still needs to be earned through evidence.',
    collocations: ['prove causation', 'correlation and causation', 'not the same as causation', 'evidence of causation', 'causation between'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Something that happens by chance, without any real connection or cause.',
    examples: [
      'The result might even be a coincidence.',
      'Without a controlled experiment, it can be difficult to tell a real effect from a simple coincidence.',
    ],
    relatedWords: ['correlation', 'causation', 'variable'],
    tags: ['science', 'core'],
    themeNote: 'The passage\'s third possible explanation, alongside correlation and other variables, for why the drink and higher scores appeared together — a reminder that not every pattern needs a cause at all.',
    collocations: ['a coincidence', 'might be a coincidence', 'just a coincidence', 'by coincidence', 'a strange coincidence'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'A tendency to favor certain evidence or conclusions, often without realizing it, especially when it matches what a person already believes.',
    examples: [
      'Scientists must also be careful about bias.',
      'If we already believe an idea is correct, we may notice evidence that supports it and ignore evidence that does not.',
    ],
    relatedWords: ['evidence', 'reliable', 'consistent'],
    tags: ['science', 'core'],
    themeNote: 'Fourth appearance of this word across the platform (Themes 3, 4, and 5 at Advanced level; now here) — worth naming honestly rather than treating as new. Here it is specifically research/confirmation bias: the tendency to notice confirming evidence and overlook the rest, distinct from Theme 5\'s media/social bias but conceptually close to it.',
    collocations: ['careful about bias', 'a source of bias', 'without bias', 'reduce bias', 'aware of bias'],
  },

  {
    id: 'se-s-09',
    word: 'consistent',
    japanese: '一貫した・安定して同様の',
    pos: 'adjective',
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Staying the same or producing the same result each time, rather than changing unpredictably.',
    examples: [
      'They also repeat experiments and ask whether other researchers can produce consistent results.',
      'Consistent results, found again and again, are what make a scientific finding trustworthy.',
    ],
    relatedWords: ['reliable', 'systematic', 'variable'],
    tags: ['science', 'core'],
    themeNote: 'Names exactly what repetition is checking for — not just that an experiment can be repeated, but that it produces the same result each time.',
    collocations: ['consistent results', 'produce consistent results', 'remain consistent', 'consistent with', 'consistently show'],
  },

  {
    ...
    introductionLevel: 'advanced',
    themes: ['science-in-everyday-life'],
    coreMeaning: 'Able to be trusted, especially because it has been tested and shown to be accurate or dependable.',
    examples: [
      'Evidence becomes more reliable when similar results are found repeatedly under careful conditions.',
      'A single result is rarely enough to call a finding reliable.',
    ],
    relatedWords: ['consistent', 'evidence', 'bias'],
    tags: ['science', 'core'],
    themeNote: 'Reinforcement of Theme 5 (facts-or-fake), where reliable described a trustworthy information source; here it describes evidence that has earned trust through repeated, consistent results — a related idea applied to experimental findings rather than sources.',
    collocations: ['more reliable', 'a reliable result', 'reliable evidence', 'become reliable', 'reliable and consistent'],
  },
];
