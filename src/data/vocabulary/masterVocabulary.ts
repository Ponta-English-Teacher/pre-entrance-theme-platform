...
export const MASTER_VOCABULARY: VocabEntry[] = [
...

  {
    ...
    coreMeaning: 'The land and buildings of a university or college.',
    examples: [
      'The campus felt huge and confusing on her very first day.',
      'There is a nice café in the middle of campus where students relax.',
    ],
    relatedWords: ['university', 'classroom', 'library'],
    tags: ['university-life'],
    themeNote: 'Campus is one of the first words students need simply to talk about where they now spend their days.',
    collocations: ['on campus', 'across campus', 'campus life', 'walk around campus', 'campus map'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'The main subject a student studies at university.',
    examples: [
      'Her first real assignment for her major was due at the end of the month.',
      'I still haven\'t decided on a major — I\'m interested in several subjects.',
    ],
    relatedWords: ['course', 'subject', 'degree'],
    tags: ['university-life', 'academic'],
    themeNote: 'Choosing and talking about a major is one of the first identity-shaping decisions of university life.',
    collocations: ['choose a major', 'my major is...', 'major in', 'declare a major', 'change your major'],
    otherMeanings: ['major (adjective): very important or serious (e.g., a major problem)', 'major (verb): to major in a subject (e.g., I majored in biology)'],
  },

  {
    ...
    examples: [
      'She felt a little more sure of herself once her first assignment was done.',
      'This assignment is due next Friday, so I should start soon.',
    ],
    relatedWords: ['homework', 'task', 'project'],
    tags: ['academic'],
    themeNote: 'University assignments require more independence than high school homework — no one reminds you to do them.',
...

  {
    ...
    examples: [
      'Becoming a university student means becoming more independent.',
      'It felt strange at first to be so independent, managing my own schedule.',
    ],
    relatedWords: ['responsibility', 'decide', 'manage'],
...

  {
    ...
    examples: [
      'University students have real responsibility for their own time.',
      'Managing your own schedule is a big responsibility at first.',
    ],
    relatedWords: ['independent', 'manage', 'decide'],
    tags: ['university-life', 'core'],
    themeNote: 'Responsibility pairs naturally with independence in this theme — freedom and responsibility arrive together, not separately.',
...

  {
    ...
    examples: [
      'She had to manage her own schedule for the first time.',
      'It takes practice to manage your time well between classes and rest.',
    ],
    relatedWords: ['responsibility', 'adjust', 'decide'],
    tags: ['university-life', 'action'],
    themeNote: 'Managing your own time is one of the most concrete daily skills this theme is really about.',
...

  {
    ...
    examples: [
      'She had to decide many things for herself, one small choice at a time.',
...

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'To think that something will happen, especially based on what you already know.',
    examples: [
      'Sora wasn\'t sure what to expect on her first day of university.',
      'I expected university to feel similar to high school, but it doesn\'t.',
    ],
    relatedWords: ['adjust', 'nervous', 'excited'],
    tags: ['university-life'],
    themeNote: 'Naming what you expected — and noticing when reality is different — is a natural way to talk about the transition into university.',
    collocations: ['not sure what to expect', 'expect something to happen', 'as expected', 'expect too much', 'didn\'t expect that'],
    otherMeanings: ['expect (pregnancy): to be expecting a baby'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'To gradually get used to a new situation.',
    examples: [
      'It took a few weeks for Sora to adjust to this new kind of freedom.',
      'Most new students need time to adjust to university life.',
    ],
    relatedWords: ['expect', 'manage', 'independent'],
    tags: ['university-life'],
    themeNote: 'Adjusting takes time, not a single moment — a useful word for describing gradual change rather than sudden change.',
    collocations: ['adjust to', 'take time to adjust', 'adjust well', 'adjust your schedule', 'still adjusting'],
    otherMeanings: ['adjust (mechanical): to change a setting on a machine or device (e.g., adjust the volume)'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'Feeling happy and full of energy about something that is going to happen.',
    examples: [
      'She felt both excited and nervous walking across the busy campus.',
      'I\'m excited to meet new people at university.',
    ],
    relatedWords: ['nervous', 'expect', 'join'],
    tags: ['university-life', 'emotion'],
    themeNote: 'Excited and nervous appear together constantly in this theme — the transition into university rarely produces only one feeling.',
    collocations: ['excited about', 'excited to do something', 'so excited', 'both excited and nervous', 'get excited'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'Feeling worried or a little afraid about something that is going to happen.',
    examples: [
      'She felt nervous, but she walked over anyway and introduced herself.',
      'It\'s normal to feel nervous before your first class.',
    ],
    relatedWords: ['excited', 'expect', 'adjust'],
    tags: ['university-life', 'emotion'],
    themeNote: 'Feeling nervous and acting anyway — not the absence of nervousness — is the theme\'s real model of courage.',
    collocations: ['feel nervous', 'nervous about', 'nervous but excited', 'a little nervous', 'make someone nervous'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'To become a member of a group, or to take part in an activity.',
    examples: [
      'A group of students were inviting people to join their photography club.',
      'I want to join a club where I can meet new people.',
    ],
    relatedWords: ['introduce', 'excited', 'nervous'],
    tags: ['university-life', 'social'],
    themeNote: 'Joining something new — a club, a group, a conversation — is one of the most concrete independent choices a new student makes.',
    collocations: ['join a club', 'join a group', 'decide to join', 'join in', 'join someone'],
  },

  {
    ...
    introductionLevel: 'foundation',
    themes: ['university-student'],
    coreMeaning: 'To tell someone your name or information about yourself when meeting them for the first time.',
    examples: [
      'She walked over anyway and introduced herself.',
      'On the first day, everyone had to introduce themselves to the class.',
    ],
    relatedWords: ['join', 'share', 'describe'],
    tags: ['university-life', 'social', 'language'],
    themeNote: 'Introducing yourself in English, to strangers, is one of the first real-world speaking tasks university brings.',
    collocations: ['introduce yourself', 'introduce someone to', 'let me introduce...', 'introduce a topic', 'briefly introduce'],
  },
