...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    titleJapanese: '未来を描く',
    description: 'Discover that your future is built gradually through ordinary experience, not found all at once in a single decision.',
    descriptionJapanese: '将来は一度の決断で見つかるものではなく、日々の経験を通して少しずつ築かれていくものだと気づきます。',
    color: 'amber',
    order: 3,
  },
  {
