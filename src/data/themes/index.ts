...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    titleJapanese: '未来を描く',
    description: 'Understand that designing a future begins with understanding yourself, not with choosing a destination.',
    descriptionJapanese: '将来を思い描くことは、目的地を選ぶことより先に、まず自分自身を理解することから始まると気づきます。',
    color: 'amber',
    order: 3,
  },
  {
